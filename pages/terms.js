        ...
        <div className={styles.legal__wrapper}>
          ...
          <div className={styles.legal__container}>
            ...
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
              Our website is hosted on the Vercel.com platform operated by
              Vercel Inc. Vercel Inc. – provides us with the technology for
              serving our site layout and graphics that enable you to interact
              with our services.
            </p>
            <p className={styles.legal__sub_title}>
              Section 1 - Web Site Terms
            </p>
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
            ...
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
              The price of our service is subject to change without notice. We
            ...
            <p className={styles.legal__sub_title}>Section 5 - Services</p>
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
              We reserve the right to modify descriptions of our services at
              anytime without notice, at the sole discretion of us. We reserve
              the right to discontinue our services any time. We do not warrant
              that the quality of our services, information, or other material
              obtained by you on our website will meet your expectations, or
            ...
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
              Certain content, and Services available via our Service may
            ...
            <p className={styles.legal__sub_title}>
              Section 9 - Comments and Feedback
            </p>
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
            ...
            >
              ...
              omissions that may relate to service description and pricing. We
              reserve the right to correct any errors, inaccuracies or
              omissions, and to change or update information without prior
              notice (including after you have engaged with the Service).
            </p>
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
            ...
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
              In no case shall Paintmuse, our directors, officers, employees,
            ...
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
              You agree to indemnify, defend and hold harmless Paintmuse and our
            ...
            <p className={styles.legal__sub_title}>Section 15 - Severability</p>
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
            ...
            <p className={styles.legal__sub_title}>Section 16 - Termination</p>
            <p
              className={`${styles.legal__paragraph} ${styles.legal__paragraph_top_padding}`}
            >
